...
its load on non-\LT bins is at least $c$\todo{only when all buckets are full}.
...
\begin{proof}[Proof of \cref{lem:PQ-properties}]
  \todo{Refer to the equation $F(f^{-1})x=Rx$}
...
$\g(b)$ are well defined).\todo{intuitions what is T}
